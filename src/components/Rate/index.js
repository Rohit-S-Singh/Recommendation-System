         ...
         <Container>
            {
                temp.map((mov)=>{
                    ...
                    <Row>
                        ...
                        <Col sm={6}><Row><Col sm={12}><h2>Bajirao</h2></Col></Row><Row><Col sm={6}></Col></Row><br></br><Row><Col sm={12}>Release Date - September 20, 2012</Col></Row><Row><Col sm={6}></Col></Row><br></br><p>Bajirao Mastani is a 2015 Indian Hindi-language epic historical romance film directed by Sanjay Leela Bhansali, who also composed its soundtrack. Jointly produced by Bhansali and Eros International's Kishore Lulla, the film stars Ranveer Singh, Deepika Padukone and Priyanka Chopra. The supporting cast includes Tanvi Azmi, Vaibhav Tatwawaadi and Milind Soman. Based on the Marathi novel Rau by Nagnath S. </p></Col>
                        <Col sm={2}>   <ReactStars
                                            count={5}
                                            onChange={(rating) => {ratingChanged(mov,rating)}}
                                            size={35}
                                            isHalf={true}
